...
class E2EWorkflowTest {
    ...
    fun testEndToEndWorkflow() = runTest {
        ...
        io.healthplatform.chartcam.initDatabase(driver) // Initialize the global db instance just in case
        ...
        val syncManager = SyncManager(fhirRepository, client)
        ...
        testScheduler.advanceUntilIdle() // Wait for initial load
        ...
        assertEquals(testNotes, encounters[0].text, "Encounter notes should match")
        assertEquals("finished", encounters[0].status, "Encounter should be marked as finished")
