    ...
    "node_modules/sql.js/dist/sql-wasm.js"(exports, module) {
      ...
      var initSqlJs2 = function(moduleConfig) {
        ...
        initSqlJsPromise = new Promise(function(resolveModule, reject) {
          ...
          if (Aa) D = za ? __require("path").dirname(D) + "/" : __dirname + "/", Fa = () => {
            Ea || (fs = __require("fs"), Ea = __require("path"));
          }, Ba = function(a, b) {
            Fa();
            a = Ea.normalize(a);
          ...
          var db2 = (a, b) => {
            ...
            (a = db2(a.split("/").filter((d) => !!d), !b).join("/")) || b || (a = ".");
            a && c && (a += "/");
            return (b ? "/" : "") + a;
          }, eb = (a) => {
          ...
          function hb() {
            ...
            a = db2(a.split("/").filter((d) => !!d), !b).join("/");
            return (b ? "/" : "") + a || ".";
          }
          function ma(a, b) {
            var c = Array(ca(a) + 1);
          ...
          var mb = { open: function(a) {
            ...
            a = db2(a.split("/").filter((k) => !!k), false);
