...
/**
 * WasmJs (Web) implementation of [FileStorage].
 * Note: File I/O uses an in-memory cache to handle file storage temporarily for WasmJs targets.
 */
...
/**
 * Factory to create [FileStorage] for WasmJs Web.
 *
