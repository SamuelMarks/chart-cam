 ...
 *
 * @property fhirRepository The repository for accessing local FHIR resources.
 * @property httpClient The HTTP client for making network requests.
 * @property fileStorage The storage implementation for accessing local files.
 */
class SyncManager(
    ...
    /**
     * The JSON encoder/decoder for FHIR R4 resources.
     */
    ...
    suspend fun syncEncounter(encounterId: String): Boolean {
        ...
        for (doc in docs) {
            ...
            try {
                ...
                val binary =
                    io.healthplatform.chartcam.models.createFhirBinary(
                        id = fileName,
     ...
     * @param lastUpdated Optional ISO-8601 date string to filter updates by (e.g. "gt2024-01-01").
     * @return true if the fetch and save operations were successful, false otherwise.
     */
    suspend fun fetchPatientHistory(
        patientId: String,
