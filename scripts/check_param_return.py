                        ...
                        if match:
                            ...
                            while j < len(lines):
                                ...
                                if found_first_paren and paren_count == 0:
                                    ...
                                    sig += " " + rest.split('{')[0].split('=')[0].strip()
                                    break
                                j += 1
                            ...
                            if ':' in post_paren and '->' not in post_paren.split(':')[0]:
                                ret_type_match = re.search(r':\s*([a-zA-Z0-9_<>?]+)', post_paren)
                            ...
                            raw_params = re.findall(r'([a-zA-Z0-9_]+)\s*:', clean_params)
                            
                            raw_params = [p for p in raw_params if p.lower() != 'modifier']
